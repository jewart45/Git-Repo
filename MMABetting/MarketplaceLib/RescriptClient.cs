    ...
    public class RescriptClient : HttpWebClientProtocol, IClient
    {
        ...
        public T Invoke<T>(string method, IDictionary<string, object> args = null)
        {
            ...
            using (StreamReader reader = new StreamReader(stream, Encoding.UTF8))
            {
                ...
                {
                    throw ReconstituteException(JsonConvert.Deserialize<Marketplace.TO.Exception>(jsonResponse));
                }
                return JsonConvert.Deserialize<T>(jsonResponse);
            }
        }

        private static System.Exception ReconstituteException(Marketplace.TO.Exception ex)
        {
            var data = ex.Detail;
        ...
        public IList<EventResult> listEvents(MarketFilter marketFilter, string locale = null) => throw new NotImplementedException();
