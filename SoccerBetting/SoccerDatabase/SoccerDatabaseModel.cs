namespace SoccerDatabase
{
    ...
    public partial class SoccerDatabaseModel : DbContext
    {
        public SoccerDatabaseModel()
            : base("name=SoccerDatabaseModel")
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            SqliteCreateDatabaseIfNotExists<SoccerDatabaseModel> sqlitConnectionInitializer = new SqliteCreateDatabaseIfNotExists<SoccerDatabaseModel>(modelBuilder);
